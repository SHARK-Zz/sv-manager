<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入用户账号" style="width: 200px" v-model="username"></el-input>
      <el-input placeholder="请输入用户昵称" style="width: 200px; margin-left: 10px" v-model="name"></el-input>
