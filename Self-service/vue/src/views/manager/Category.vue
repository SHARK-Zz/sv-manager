  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="name" label="菜品分类名称"></el-table-column>
    ...
    <el-dialog title="商家菜品分类" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <div style="height: 300px; overflow: auto">
        <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
          <el-form-item label="分类名称" prop="name">
            <el-input v-model="form.name" placeholder="请输入菜品分类名称"></el-input>
          </el-form-item>
          <el-form-item label="商家" prop="businessId" v-if="user.role === 'ADMIN'">
            <el-select style="width: 100%" v-model="form.businessId" placeholder="请选择对应商家">
