...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'adminPerson', name: 'AdminPerson', meta: { name: '个人信息修改' }, component: () => import('../views/manager/AdminPerson') },
      { path: 'businessPerson', name: 'BusinessPerson', meta: { name: '商家信息修改' }, component: () => import('../views/manager/BusinessPerson') },
